...
export const PICTOS: { [id: string]: PictoEntry } = {
  ...
  "onMapPOIs/arrivee": { family: "onMapPOIs", glyph: "arrivee", files: { svg: "Arrivee.svg" } },
  ...
  "onMapPOIs/depart": { family: "onMapPOIs", glyph: "depart", files: { svg: "Depart.svg" } },
  ...
  "onMapPOIs/zone_administrative": { family: "onMapPOIs", glyph: "zone_administrative", files: { svg: "ZoneAdministrative.svg" } },
  "onMapPOIs/zone_protegee": { family: "onMapPOIs", glyph: "zone_protegee", files: { svg: "ZoneProtegee.svg" } },
  ...
  "topos/difficulty_rating": { family: "topos", glyph: "difficulty_rating", files: { svg: "difficulty rating.svg" } },
  ...
  "topos/finish": { family: "topos", glyph: "finish", files: { svg: "Finish.svg" } },
  ...
  "topos/negative_elevation": { family: "topos", glyph: "negative_elevation", files: { svg: "negative elevation.svg" } },
  ...
  "topos/positive_elevation": { family: "topos", glyph: "positive_elevation", files: { svg: "positive elevation.svg" } },
  ...
  "topos/start": { family: "topos", glyph: "start", files: { svg: "Start.svg" } },
  "topos/start_elevation": { family: "topos", glyph: "start_elevation", files: { svg: "Start_elevation.svg" } },
